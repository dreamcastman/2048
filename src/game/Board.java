...
public class Board {
    ...
    public void addRandomTile() {
        ...
        BoardSpot free = openSpaces.get(t);
    ...
    public void swipeLeft() {
        //go through the tiles, if not empty, move them left/replace the empty
        //and make empty after moving
        //go row by row, traversing the columns
        for ( int r = 0; r < gameBoard.length; r++ ) {
            int i = 0;
            for ( int c = 0; c < gameBoard[r].length; c++ ) {
                if (gameBoard[r][c] != 0) {
                    if (c != i) {
                        gameBoard[r][i] = gameBoard[r][c];
                        gameBoard[r][c] = 0;
                    }
                    i++;
                }
    ...
    public void transpose() {
        int[][] transposeBoard = new int[4][4];
        for (int r = 0; r < 4; r++) {
            for (int c = 0; c < 4; c++) {
                transposeBoard[c][r] = gameBoard[r][c];
            }
        }
    ...
    public void flipRows() {
        for (int r = 0; r < 4; r++) {
            ...
            while (lpointer < rpointer) {
                ...
                int temp = gameBoard[r][lpointer];
                gameBoard[r][lpointer] = gameBoard[r][rpointer];
                gameBoard[r][rpointer] = temp;
